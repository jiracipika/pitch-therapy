...
export default function ChordDetectivePage() {
  ...
  const [results, setResults] = useState<
    { round: number; correct: boolean; root: string; type: string; answer: string }[]
  >([]);
  ...
  const submitAnswer = () => {
    ...
    setResults((r) => [
      ...r,
      {
        round,
        correct: allCorrect,
        root: targetRootRef.current,
        type: targetTypeRef.current,
            ...
            {CHORD_TYPES.map((ct) => (
              <motion.button
                ...
                style={{
                  ...
                  border:
                    selectedType === ct.id ? `2px solid ${ACCENT}` : "1.5px solid transparent",
              ...
              {ALL_NOTES.map((note) => (
                <motion.button
                  ...
                  style={{
                    ...
                    border:
                      selectedRoot === note ? `2px solid ${ACCENT}` : "1.5px solid transparent",
