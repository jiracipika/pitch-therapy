...
export default function TuningBattlePage() {
  ...
  }, [phase, recordResult, players, totalRounds]);
        ...
        {phase === "ready" && (
          <div style={{ textAlign: "center", paddingTop: 60 }}>
            <div style={{ marginBottom: 16 }}>
              ...
              <span
                style={{ marginLeft: 8, fontSize: 24, fontWeight: 700, color: "var(--ios-label)" }}
              >
                {targetNote}
              </span>
            </div>
              ...
              <div className="ios-card" style={{ padding: 14 }}>
                  ...
                  {p1Notes.map((note) => (
                    <motion.button
                      ...
                      style={{
                        ...
                        fontWeight: 700,
                        background:
                          players[0].selectedNote === note
                            ? "rgba(255,255,255,0.2)"
                            : "var(--ios-bg3)",
                        border:
                          players[0].selectedNote === note
                            ? "1px solid rgba(255,255,255,0.4)"
                            : "1px solid var(--ios-sep)",
                        color: "var(--ios-label)",
                        cursor: "pointer",
                      }}
                    >
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    fontSize: 12,
                    fontWeight: 700,
                    background: players[0].lockedIn
                      ? "rgba(48,209,88,0.2)"
                      : players[0].selectedNote
                        ? "rgba(255,69,58,0.2)"
                        : "var(--ios-bg3)",
                    border: players[0].lockedIn
                      ? "1px solid var(--ios-green)"
                      : players[0].selectedNote
                        ? "1px solid var(--ios-red)"
                        : "1px solid var(--ios-sep)",
                    color: players[0].lockedIn
                      ? "var(--ios-green)"
                      : players[0].selectedNote
                        ? "var(--ios-red)"
                        : "var(--ios-label3)",
              ...
              <div className="ios-card" style={{ padding: 14 }}>
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    fontSize: 12,
                    fontWeight: 700,
                    background: players[1].lockedIn
                      ? "rgba(48,209,88,0.2)"
                      : players[1].selectedNote
                        ? "rgba(255,69,58,0.2)"
                        : "var(--ios-bg3)",
                    border: players[1].lockedIn
                      ? "1px solid var(--ios-green)"
                      : players[1].selectedNote
                        ? "1px solid var(--ios-red)"
                        : "1px solid var(--ios-sep)",
                    color: players[1].lockedIn
                      ? "var(--ios-green)"
                      : players[1].selectedNote
                        ? "var(--ios-red)"
                        : "var(--ios-label3)",
          ...
          >
            {roundWinner ? (
              <>
                ...
                <div style={{ fontSize: 24, fontWeight: 700, color: "var(--ios-label)" }}>
                  {roundWinner} wins!
                </div>
              </>
            ) : (
            ...
            <div style={{ fontSize: 14, color: "var(--ios-label3)", marginTop: 8 }}>
              Target was{" "}
              <span style={{ color: "var(--ios-label)", fontWeight: 600 }}>{targetNote}</span>
            </div>
            <div
              style={{
                display: "flex",
            ...
            >
              <div className="ios-card" style={{ padding: "12px 20px" }}>
                <div style={{ fontSize: 14, color: "var(--ios-label3)" }}>
                  P1: {players[0].score}
                </div>
              </div>
              <div className="ios-card" style={{ padding: "12px 20px" }}>
